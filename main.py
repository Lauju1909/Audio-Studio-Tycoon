...
def setup_router(audio, state):
    ...
    routes = {
        ...
        "drm_choice": lambda: DRMChoiceMenu(audio, state),
        "crowdfunding_choice": lambda: CrowdfundingChoiceMenu(audio, state),
        ...
        "contract_work_menu": lambda: __import__('menus.business', fromlist=['']).ContractWorkMenu(audio, state),
        ...
        "soundcon_qa_menu": lambda: __import__('menus.events', fromlist=['']).SoundConQAMenu(audio, state),
        ...
        "hardware_type_select": lambda: __import__('menus.hardware', fromlist=['']).HardwareTypeSelectMenu(audio, state),
