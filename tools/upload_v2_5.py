...
TAG = "v2.5.0"
FILE_PATH = r"c:\Users\lauri\.gemini\antigravity\scratch\game_dev_tycoon_2\Audio_Studio_Tycoon_v2.5.zip"
FILE_NAME = "Audio_Studio_Tycoon_v2.5.zip"
...
def create_and_upload():
    ...
    data = {
        "tag_name": TAG,
        "name": f"Release {TAG} - Grand Encyclopedia",
        "body": "Version 2.5: Grand Encyclopedia, Achievements, Saisonales Geschäft, HR-Spezialisierungen, MMO Lootboxen.",
        "draft": False,
        "prerelease": False
    }
