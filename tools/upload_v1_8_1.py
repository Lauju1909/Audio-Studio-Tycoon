...
TAG = "v1.8.1"
FILE_PATH = r"c:\Users\lauri\.gemini\antigravity\scratch\game_dev_tycoon_2\Audio_Studio_Tycoon_v1.8.1.zip"
FILE_NAME = "Audio_Studio_Tycoon_v1.8.1.zip"
...
def create_and_upload():
    ...
    data = {
        "tag_name": TAG,
        "name": f"Release {TAG}",
        "body": "Stabiler Build 1.8.1: Installer mit Hauptordner, Updater bereinigt alte exes.",
        "draft": False,
        "prerelease": False
    }
