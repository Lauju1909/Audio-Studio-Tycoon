...
TAG = "v2.7.0"
NAME = "Audio Studio Tycoon v2.7.0 (Phase F Update)"
BODY = "Release 2.7.0 - Phase F Update\n\nFeatures:\n- Merchandising (Shop & Lager): Produziere und verkaufe Fan-Artikel für passives Einkommen.\n- E-Sports & Turniere: Veranstalte riesige Events für Hype und Fan-Boosts.\n- Firmenübernahmen (M&A): Kaufe Konkurrenten auf und sichere dir 100% ihrer Einnahmen.\n\nAlle neuen Funktionen sind wie gewohnt zu 100% Screenreader-kompatibel."

FILE_PATH = r"g:\Andere Computer\Mein Computer\.gemini\antigravity\scratch\game_dev_tycoon_2\Audio_Studio_Tycoon_v2.7.0.zip"
FILE_NAME = "Audio_Studio_Tycoon_v2.7.0.zip"
